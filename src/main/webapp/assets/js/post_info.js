...
$(function(){
    ...
    $(".post_list_table .member_data").click(function(){
    ...
    $("#add_btn").click(function(){
        ...
        if(AddBtn){
            ...
            $("#add_btn").html("저장")
            $(".post_list_table th:nth-child(8)").html("비밀번호")
            $(".post_list_table th:nth-child(9)").html("비밀번호 확인")
    ...
    $(".post_list_table .member_data").dblclick(function(){
